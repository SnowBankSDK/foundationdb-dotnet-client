...
namespace SnowBank.Text
{
	...
	public static class Base1024Encoding
	{
		...
		/// <returns>Encoded string literal that preserves the ordering of the input value</returns>
		/// <remarks>
		/// <para>The input string will be encoded into UTF-8 bytes first, and then these bytes will be encoded by calling <see cref="Encode(System.ReadOnlySpan{byte})"/></para>
		...
		/// <remarks>The caller can determine the minimum buffer capacity by calling <see cref="GetByteCount"/>.</remarks>
