...
<!--
	...
	This stylesheet is intentionally profile-agnostic: it reads the DataContract-compat format shape (no namespaces,
	explicit nil="true" markers, ordinal member names) produced identically by CrystalXml and by a live
	DataContractSerializer, so the SAME stylesheet transforms either format.
-->
